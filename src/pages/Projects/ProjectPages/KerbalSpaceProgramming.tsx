...
export default function Kerbal() {
    return (
        <div id='kerbal-page' className="project-content ml-60 p-10 w-[calc(100vw-240px)] h-screen text-white overflow-x-hidden overflow-y-scroll no-scrollbar">
            <div className="text-white text-lg">
                ...
                <h1 className="text-3xl text-center font-bold mb-4">Kerbal Space Programming</h1>
