    ...
    return (
        <div id='teleop-page' className="project-content ml-60 p-10 w-[calc(100vw-240px)] h-screen text-white overflow-x-hidden overflow-y-scroll no-scrollbar">
            <div className="text-white text-lg">
                ...
                <i className='block text-center font-semibold mb-8'>I am currently working on this project so this page is a work in progress.</i>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl hover:bg-white/15 transition-all duration-300">
                        ...
                        <div className="space-y-6">
                            <p className="text-lg leading-relaxed text-gray-100">
                                RASSOR stands for 'Regolith Advanced Surface Systems Operational Robot', the original rover is an impressive feat of engineering that is being <a target="_blank" rel="noopener noreferrer" href="https://technology.nasa.gov/patent/KSC-TOPS-7" className="text-blue-300 hover:text-blue-200 underline transition-colors duration-200">developed by NASA</a>, to be used in future as an excavation rover on Earth and, in the future, extraterrestrial bodies. 
                            </p>
                            
                            <p className="text-lg leading-relaxed text-gray-100">    
                                The Florida Space Institute(FSI) is offering a research and educational aspect of this rover that can be used in a more non-commericial, academic sense. Hence, they call it the <a target="_blank" rel="noopener noreferrer" href="https://fsi.ucf.edu/student-design/robotics/re-rassor/" className="text-blue-300 hover:text-blue-200 underline transition-colors duration-200">RE-RASSOR rover</a>, the 'RE' standing for 'Research and Education.' They are aiming to use open-source parts and software to as a platform for lower cost research, and the ability to support STEAM education for elementary and middle school kids, who are given the 3D printed parts and instructed on how to put it together themselves.
                            </p>
