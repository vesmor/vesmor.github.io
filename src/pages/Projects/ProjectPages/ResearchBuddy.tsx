                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl hover:bg-white/15 transition-all duration-300">
                        ...
                        <div className="space-y-6">
                            <p className="text-lg leading-relaxed text-gray-100">
                               Like a lot of college students, whenever I wanted to make quick cash I would sign up to do little research studies at my University. The lab that conducted a lot of these studies was the <a href="https://www.eecs.ucf.edu/isuelab/" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 underline transition-colors duration-200">Interactive Systems and User Experience(ISUE) Lab</a>. After doing a few of their studies, I decided to join their Discord server to keep up with their studies. One day, I was notified of a small project they were offering their Undergraduate Students. They wanted a Discord bot that would remind the lab members of their conference dates.
                            </p>
                            <div className="flex flex-col items-center mt-4">
                                <img src='/assets/images/ResearchBuddy/isue-request.png' alt='Discord Bot request' className='h-[50%] w-[50%] rounded'/>
                                <i className="text-gray-300 italic mt-2">If only Amazon's Alexa was integrated into Discord</i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl hover:bg-white/15 transition-all duration-300">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col items-center mt-4 ">
                                ...
                                <i className="text-gray-300 italic mt-2">Screencaps of a couple test commands</i>
                            </div>    
                        </div>
                    </div>
                </div>
