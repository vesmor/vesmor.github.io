...
export default function About() {
    return (
        <div className="text-white ">
            ...
            <div className="container ml-60 p-4 w-[calc(100vw-240px)] overflow-x-hidden overflow-y-scroll no-scrollbar">
            <AnimatedPage>
                <h1 className="text-4xl font-bold mb-6">About Me</h1>
                <div className="aboutme-container ml-16 py-16 h-screen">
